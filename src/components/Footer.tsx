    ...
    <footer className="bg-white pt-20 pb-10 border-t border-black/[0.08]">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            >
              <img
                src={logo}
                alt="Muscle Empire"
                className="h-12 w-12 rounded-full object-cover border-[1.5px] border-[#E8A820]/50 group-hover:border-[#E8A820] transition-colors"
              />
              <span className="font-display font-black text-[1.1rem] text-[#E8A820] tracking-tight">
                Muscle Empire
              </span>
            </button>
          ...
          {/* Quick links */}
          <div>
            <h4 className="text-[#F2EFE9] font-bold text-[13px] uppercase tracking-widest mb-5">Quick links</h4>
